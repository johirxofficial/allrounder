...
import com.allrounder.app.adapters.CategoryAdapter;
import com.allrounder.app.adapters.EventAdapter;
import com.allrounder.app.models.AppData;
import com.allrounder.app.models.Category;
import com.allrounder.app.models.Event;
import com.allrounder.app.network.ApiClient;
import com.allrounder.app.utils.Constants;
...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean bannerDismissedThisSession = false;
    ...
    private void bindViews() {
        ...
        imgBannerAd = findViewById(R.id.imgBannerAd);
    ...
    private void bindBannerAd() {
        if (bannerDismissedThisSession) return;

        boolean showBanner = appData.ads != null
                && appData.ads.banner != null
                && appData.ads.banner.enabled
                && appData.ads.banner.imageUrl != null
                && !appData.ads.banner.imageUrl.trim().isEmpty();
        ...
        Glide.with(this)
                .load(appData.ads.banner.imageUrl)
                .into(imgBannerAd);

        bannerAdContainer.setVisibility(View.VISIBLE);
        imgBannerAd.setOnClickListener(v -> openUrl(appData.ads.banner.clickUrl));
    }
    ...
    private void openPlayer(Event event) {
        ...
        if (appData != null && appData.ads != null && appData.ads.videoPreroll != null) {
            intent.putExtra(Constants.EXTRA_ADS_JSON, new Gson().toJson(appData.ads.videoPreroll));
        }
