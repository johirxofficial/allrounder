...
import com.allrounder.app.models.VideoAdConfig;
import com.allrounder.app.models.DrmKeys;
import com.allrounder.app.models.Event;
import com.allrounder.app.models.StreamingSource;
import com.allrounder.app.utils.Constants;
import com.allrounder.app.utils.DateUtils;
...
public class PlayerActivity extends AppCompatActivity {
    ...
    private static final String USER_AGENT =
            "Mozilla/5.0 (SmartTV; Linux; Android 9) Allrounder/1.0.4";
    ...
    private void parseIntentData() {
        ...
        if (adsJson != null) {
            adConfig = new Gson().fromJson(adsJson, VideoAdConfig.class);
        }
    }
    ...
    private void showError(String message) {
        ...
        if (errorOverlay.getVisibility() != View.VISIBLE) {
            errorOverlay.startAnimation(
                    android.view.animation.AnimationUtils.loadAnimation(this, R.anim.fade_scale_in));
        }
